...
var lis3 = document.querySelectorAll('.history .end .l ul li')
var container = document.querySelectorAll('.history .container')
var prev = document.querySelector('.prev')
var next = document.querySelector('.next')
var ul1 = document.querySelector('.team .banner .image ul')
...
for (let i = 0; i < lis3.length; i++) {
    ...
    lis3[i].onmouseenter = function () {
        for (let j = 0; j < lis3.length; j++) {
            ...
            lis3[j].classList.remove('hh')
        }
        container[this.index].classList.add('active')
...
prev.onclick = function () {
    ...
    if (index < 0) {
        index = 1;
        ul1.style.marginLeft = '-1255px'
    }
    animate(ul1, {
        marginLeft: -index * 1004 + 'px'
    })
}
